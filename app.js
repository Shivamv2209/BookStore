...
app.get("/auth/google/BookStore", passport.authenticate("google",{
...
app.post("/signup",async (req,res)=>{
    ...
    let existUser = await user_model.findOne({email:email});
    if(existUser){
        res.redirect("/login");
    }else{
    ...
    new GoogleStrategy(
      {
        ...
        callbackURL: "http://localhost:3000/auth/google/BookStore",
      },
